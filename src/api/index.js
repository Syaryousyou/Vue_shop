...
// 如果请求路径不加BASE_URL，请求的地址是http://localhost:8000/+path
// 加上BASE_URL后，请求http://localhost:4000/+path，会出现跨域
// 解决方案：后台设置cors
// const BASE_URL = 'http://localhost:4000/'
// 所有的path前加'/api'，用前台配置代理
const BASE_URL = '/api'
// 1、根据经纬度获取位置详情
...
// 7、发送短信验证码
export const reqSendMssage = phone => ajax(BASE_URL + '/sendcode', {phone})
// 8、手机号验证码登陆
